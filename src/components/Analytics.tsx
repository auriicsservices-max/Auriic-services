    ...
    <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        <div className="bg-white p-6 rounded-[2rem] border border-slate-200 shadow-sm">
          ...
          <p className="text-[10px] text-slate-400 uppercase font-bold tracking-widest">Talent Pool</p>
        ...
        <div className="bg-white p-6 rounded-[2rem] border border-slate-200 shadow-sm">
          ...
          <p className="text-[10px] text-slate-400 uppercase font-bold tracking-widest">Unique Domains</p>
          <h3 className="text-2xl font-bold text-amber-600 tracking-tight">
            {Object.keys(domainDataMap).length}
          </h3>
        </div>
        <div className="bg-white p-6 rounded-[2rem] border border-slate-200 shadow-sm">
          <div className="w-10 h-10 bg-indigo-900 rounded-xl flex items-center justify-center text-white mb-4">
            <TrendingUp size={20} />
          </div>
          <p className="text-[10px] text-slate-400 uppercase font-bold tracking-widest">Avg Skills/CV</p>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        {/* Domain Distribution */}
        <section className="bg-white p-8 rounded-[2.5rem] border border-slate-200 shadow-sm min-h-[400px] flex flex-col">
          <div className="mb-6">
            <h3 className="text-xl font-serif text-slate-800">Domain Distribution</h3>
            <p className="text-[10px] uppercase font-bold tracking-widest text-slate-400">Industry landscape of talent pool</p>
          </div>
        ...
        <section className="bg-white p-8 rounded-[2.5rem] border border-slate-200 shadow-sm min-h-[400px] flex flex-col">
          <div className="mb-6">
            <h3 className="text-xl font-serif text-slate-800">In-Demand Skills</h3>
            <p className="text-[10px] uppercase font-bold tracking-widest text-slate-400">Most frequent technologies & tools</p>
          </div>
          <div className="flex-1 w-full h-[300px]">
            <ResponsiveContainer width="100%" height="100%">
