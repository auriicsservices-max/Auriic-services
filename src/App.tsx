  ...
  if (!role) {
    return (
      <div className="h-screen w-full flex items-center justify-center bg-slate-50 p-4">
        <div className="bg-white p-8 rounded-[2rem] border border-slate-200 shadow-xl max-w-md text-center space-y-4">
          ...
          <h2 className="text-2xl font-serif text-slate-800">Access Denied</h2>
          <p className="text-slate-500 text-sm">Your account is not authorized to access the Recruitment Portal. Please contact an administrator for an invitation.</p>
          <button 
